...
Empieza una [nueva discusión](https://github.com/josantonius/php-url/discussions/new) y selecciona
...
abre una [nueva discusión](https://github.com/josantonius/php-url/discussions/new) en la categoría
...
[repositorio](https://github.com/josantonius/php-url). O mejor aún, puedes
...
[Envía un nuevo _issue_](https://github.com/josantonius/php-url/issues/new) para reportar un error.
...
1. Busca en [GitHub](https://github.com/josantonius/php-url/pulls) si existe algún tema relacionado
para asegurarte que no esté repetido.

1. [Bifurca](https://github.com/josantonius/php-url/fork) el repositorio a tu propia cuenta de GitHub.
...
1. En GitHub, envía un [_pull request_](https://github.com/josantonius/php-url/compare/main..)
hacia `php-url:main`.
